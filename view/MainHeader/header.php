<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            <img class="hidden-md-down" src="../../Docs/ricon.png" alt="">
        </a>
        ...
        <div class="site-header-content">
            <div class="site-header-content-in">
                <div class="site-header-shown">
                    <div class="dropdown user-menu">
                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="../../Docs/<?php echo $_SESSION["rol_id"] ?>.jpg" alt="">
                        </button>
                ...
                <input type="hidden" id="user_idx" value="<?php echo $_SESSION["usu_id"] ?>">  <!--ID USUARIO  -->
                
                <input type="hidden" id="rol_idx" value="<?php echo $_SESSION["rol_id"] ?>">  <!--ROL USUARIO  -->
